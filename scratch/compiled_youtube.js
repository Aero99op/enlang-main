...
const homeCatalog = [ { id : "gJrjgg1KVL4" , title : "Spring Boot 3 Full Course 2025 - Beginner to Pro" , channel : "Spandan Prayas Patra" , subs : "128K subscribers" , views : "1,039,987 views • Premiered on Aug 15, 2026" , desc : "In this deep dive tutorial, Spandan Prayas Patra walks through architecting mission-critical Java 21 backend microservices, configuring HikariCP connection pools for Oracle & MySQL, and applying strict ACID transaction management." , category : "Java Backend" , ambient : "rgba(59, 130, 246, 0.35)" , duration : "1:11:22" , avatar : "S" } , { id : "0e3GPea1Tyg" , title : "$456,000 Squid Game In Real Life!" , channel : "MrBeast" , subs : "310M subscribers" , views : "630,240,119 views • 2 years ago" , desc : "456 people compete for $456,000 in real life recreation of Squid Game! Red Light Green Light, Dalgona, Tug of War, Marbles, Glass Bridge, and the Final Battle." , category : "Science & Tech" , ambient : "rgba(239, 68, 68, 0.35)" , duration : "25:41" , avatar : "M" } , { id : "dQw4w9WgXcQ" , title : "Rick Astley - Never Gonna Give You Up (Official Music Video 4K Remaster)" , channel : "Rick Astley" , subs : "3.4M subscribers" , views : "1,520,840,112 views • 14 years ago" , desc : "The official video for 'Never Gonna Give You Up' by Rick Astley. 4K Remastered with studio high definition audio." , category : "Lo-Fi Music" , ambient : "rgba(236, 72, 153, 0.35)" , duration : "03:33" , avatar : "R" } , { id : "8aGhZQkoFbQ" , title : "Next.js 15 & React 19 Full Stack Masterclass (App Router, Server Actions)" , channel : "JavaScript Mastery" , subs : "1.1M subscribers" , views : "489,420 views • 3 weeks ago" , desc : "Master full-stack Next.js with Server Actions, Edge Middleware, and Cloudflare Deployments with zero 500 errors." , category : "Next.js" , ambient : "rgba(16, 185, 129, 0.35)" , duration : "2:45:10" , avatar : "J" } , { id : "pTJJsmejUOQ" , title : "Flutter 3.24 & Dart Full Course for Cross-Platform Mobile Apps" , channel : "FreeCodeCamp" , subs : "9.8M subscribers" , views : "1,420,150 views • 2 months ago" , desc : "Build cross-platform iOS & Android mobile applications with clean architecture and state management." , category : "Enlang Stack" , ambient : "rgba(20, 184, 166, 0.35)" , duration : "4:32:00" , avatar : "F" } , { id : "L_LUpnjgPso" , title : "Grand Theft Auto VI Official Trailer 1 - 4K 60FPS" , channel : "Rockstar Games" , subs : "10.8M subscribers" , views : "215,900,000 views • 8 months ago" , desc : "Grand Theft Auto VI heads to the state of Leonida, home to the neon-soaked streets of Vice City." , category : "Gaming" , ambient : "rgba(236, 72, 153, 0.35)" , duration : "01:31" , avatar : "R" } , { id : "Q7AOvWpIVHU" , title : "Three.js 3D Web Graphics & WebGL Shaders Masterclass" , channel : "Creative Coding 3D" , subs : "340K subscribers" , views : "340,900 views • 5 days ago" , desc : "Shader art tutorial implementing dual plasma rings and procedural celestial textures in WebGL." , category : "Coding & AI" , ambient : "rgba(99, 102, 241, 0.35)" , duration : "21:15" , avatar : "T" } , { id : "W6NZfCO5SIk" , title : "JavaScript Tutorial for Beginners: Learn JavaScript in 1 Hour [2025]" , channel : "Programming with Mosh" , subs : "4.1M subscribers" , views : "14,200,000 views • 4 years ago" , desc : "Watch this JavaScript tutorial for beginners to learn JavaScript basics in 1 hour. Get started with frontend and fullstack web development." , category : "Coding & AI" , ambient : "rgba(234, 179, 8, 0.35)" , duration : "48:16" , avatar : "P" } , { id : "h4T_LlK1VE4" , title : "Glitter Bomb 4.0 vs. Porch Pirates" , channel : "Mark Rober" , subs : "56.4M subscribers" , views : "74,900,000 views • 2 years ago" , desc : "The engineering-heavy glitter bomb trap for package thieves featuring fart spray and 360-degree phone cameras." , category : "Science & Tech" , ambient : "rgba(234, 179, 8, 0.35)" , duration : "22:30" , avatar : "M" } , { id : "fJ9rUzIMcZQ" , title : "Queen - Bohemian Rhapsody (Official Video Remastered)" , channel : "Queen Official" , subs : "18.2M subscribers" , views : "1,740,290,000 views • 15 years ago" , desc : "The official music video for Queen's iconic Bohemian Rhapsody, remastered in HD." , category : "Lo-Fi Music" , ambient : "rgba(168, 85, 247, 0.35)" , duration : "05:59" , avatar : "Q" } , { id : "kXYiU_JCYtU" , title : "Linkin Park - Numb (Official Music Video 4K)" , channel : "Linkin Park" , subs : "21.4M subscribers" , views : "2,210,000,000 views • 17 years ago" , desc : "'Numb' by Linkin Park from the album Meteora. 4K Ultra High Definition remastered." , category : "Lo-Fi Music" , ambient : "rgba(59, 130, 246, 0.35)" , duration : "03:07" , avatar : "L" } , { id : "5qap5aO4i9A" , title : "lofi hip hop radio 📚 - beats to relax/study to" , channel : "Lofi Girl" , subs : "14.1M subscribers" , views : "148,400,000 views • Live 24/7" , desc : "Peaceful lofi hip hop beats to relax, study, code, and sleep to. Welcome to the official Lofi Girl stream." , category : "Lo-Fi Music" , ambient : "rgba(236, 72, 153, 0.35)" , duration : "LIVE" , avatar : "L" } , { id : "Un5SEJ8MyPc" , title : "Cyberpunk 2077: Phantom Liberty - Official Cinematic Trailer" , channel : "Cyberpunk 2077" , subs : "1.4M subscribers" , views : "14,200,000 views • 1 year ago" , desc : "Return to Night City in this spy-thriller expansion featuring Idris Elba as Solomon Reed." , category : "Gaming" , ambient : "rgba(234, 179, 8, 0.35)" , duration : "04:12" , avatar : "C" } , { id : "MBRqu0YOH14" , title : "The Egg - A Short Story" , channel : "Kurzgesagt – In a Nutshell" , subs : "22.8M subscribers" , views : "34,200,000 views • 4 years ago" , desc : "A philosophical animation of Andy Weir's 'The Egg'. What if every single person in human history was you?" , category : "Science & Tech" , ambient : "rgba(20, 184, 166, 0.35)" , duration : "08:04" , avatar : "K" } , { id : "aircAruvnKk" , title : "But what is a neural network? | Deep learning, Chapter 1" , channel : "3Blue1Brown" , subs : "6.4M subscribers" , views : "17,800,000 views • 6 years ago" , desc : "Visual explanation of neural networks, weights, biases, and gradient descent mathematically visualized." , category : "Coding & AI" , ambient : "rgba(59, 130, 246, 0.35)" , duration : "19:13" , avatar : "3" } , { id : "7wnove7K-ZQ" , title : "Python Tutorial for Beginners - Full Course [2025]" , channel : "Programming with Mosh" , subs : "4.1M subscribers" , views : "38,500,000 views • 5 years ago" , desc : "Learn Python programming from scratch. Variables, loops, functions, lists, dictionaries, classes, and real projects." , category : "Coding & AI" , ambient : "rgba(234, 179, 8, 0.35)" , duration : "6:14:07" , avatar : "P" } , { id : "bHIhgxav9LY" , title : "Why It's Impossible to Make a Round Object" , channel : "Veritasium" , subs : "16.1M subscribers" , views : "19,800,000 views • 5 years ago" , desc : "Creating the most perfect sphere in the universe to redefine the standard kilogram." , category : "Science & Tech" , ambient : "rgba(16, 185, 129, 0.35)" , duration : "12:19" , avatar : "V" } , { id : "eaW0tYpxyp0" , title : "Elden Ring - Official Gameplay Reveal Trailer" , channel : "Bandai Namco" , subs : "2.1M subscribers" , views : "16,400,000 views • 3 years ago" , desc : "Rise, Tarnished, and be guided by grace to brandish the power of the Elden Ring and become an Elden Lord in the Lands Between." , category : "Gaming" , ambient : "rgba(234, 179, 8, 0.35)" , duration : "02:58" , avatar : "B" } , { id : "bMknfKXIFA8" , title : "React Course - Beginner's Tutorial for React Javascript Library [2025]" , channel : "FreeCodeCamp" , subs : "9.8M subscribers" , views : "8,900,000 views • 2 years ago" , desc : "Learn React JS from scratch by building 8 projects step-by-step with state, hooks, and clean components." , category : "Coding & AI" , ambient : "rgba(59, 130, 246, 0.35)" , duration : "11:55:27" , avatar : "F" } , { id : "kJQP7kiw5Fk" , title : "Luis Fonsi - Despacito ft. Daddy Yankee" , channel : "Luis Fonsi" , subs : "32.1M subscribers" , views : "8,500,000,000 views • 7 years ago" , desc : "Despacito official music video by Luis Fonsi & Daddy Yankee. 8.5+ Billion views worldwide." , category : "Lo-Fi Music" , ambient : "rgba(239, 68, 68, 0.35)" , duration : "04:41" , avatar : "D" } , { id : "9bZkp7q19f0" , title : "PSY - GANGNAM STYLE(강남스타일) M/V" , channel : "OfficialPsy" , subs : "18.5M subscribers" , views : "5,200,000,000 views • 12 years ago" , desc : "PSY - GANGNAM STYLE (강남스타일) Official Music Video. The first video to cross 1 Billion views in history." , category : "Lo-Fi Music" , ambient : "rgba(239, 68, 68, 0.35)" , duration : "04:13" , avatar : "P" } , { id : "JGwWNGJdvx8" , title : "Ed Sheeran - Shape of You (Official Music Video)" , channel : "Ed Sheeran" , subs : "55.1M subscribers" , views : "6,200,000,000 views • 7 years ago" , desc : "The official music video for Ed Sheeran - Shape of You from the album ÷ (Divide)." , category : "Lo-Fi Music" , ambient : "rgba(59, 130, 246, 0.35)" , duration : "04:23" , avatar : "E" } , { id : "jNQXAC9IVRw" , title : "Me at the zoo (First YouTube Video in History)" , channel : "jawed" , subs : "4.8M subscribers" , views : "325,000,000 views • 19 years ago" , desc : "The first video on YouTube, uploaded on April 23, 2005. Recorded at the San Diego Zoo by Jawed Karim." , category : "All" , ambient : "rgba(34, 197, 94, 0.35)" , duration : "00:19" , avatar : "J" } ];

const subsCatalog = [ { id : "gJrjgg1KVL4" , title : "Java 21 Virtual Threads & Low Latency Concurrency" , channel : "Spandan Prayas Patra" , views : "412K views • 2 days ago" , duration : "48:15" , avatar : "S" } , { id : "8aGhZQkoFbQ" , title : "Next.js 15 Server Actions & Cloudflare Workers 0ms Latency" , channel : "JavaScript Mastery" , views : "290K views • 4 days ago" , duration : "1:15:30" , avatar : "J" } , { id : "0e3GPea1Tyg" , title : "I Spent 7 Days Stranded In An Abandoned City" , channel : "MrBeast" , views : "89M views • 1 week ago" , duration : "22:10" , avatar : "M" } , { id : "pTJJsmejUOQ" , title : "React Native 2025 Architecture Full Course" , channel : "FreeCodeCamp" , views : "820K views • 1 week ago" , duration : "3:40:00" , avatar : "F" } , { id : "bHIhgxav9LY" , title : "The World's Roundest Object & The Kilogram Definition" , channel : "Veritasium" , views : "12M views • 2 weeks ago" , duration : "11:20" , avatar : "V" } , { id : "L_LUpnjgPso" , title : "Grand Theft Auto VI - Vice City Neon Graphics Gameplay" , channel : "Rockstar Games" , views : "18M views • 3 weeks ago" , duration : "12:00" , avatar : "R" } , { id : "MBRqu0YOH14" , title : "What If We Nuke A City? (Simulation & Science)" , channel : "Kurzgesagt" , views : "24M views • 1 month ago" , duration : "10:14" , avatar : "K" } , { id : "W6NZfCO5SIk" , title : "Node.js Crash Course for Web Developers" , channel : "Programming with Mosh" , views : "3.1M views • 2 weeks ago" , duration : "1:02:18" , avatar : "P" } ];

const historyCatalog = [ { id : "gJrjgg1KVL4" , title : "Spring Boot 3 Full Course 2025 - Beginner to Pro" , channel : "Spandan Prayas Patra" , views : "1.0M views" , time : "Watched 1 hour ago" , duration : "1:11:22" } , { id : "8aGhZQkoFbQ" , title : "Next.js 15 & React 19 Full Stack Masterclass" , channel : "JavaScript Mastery" , views : "489K views" , time : "Watched 4 hours ago" , duration : "2:45:10" } , { id : "dQw4w9WgXcQ" , title : "Rick Astley - Never Gonna Give You Up (Official Video)" , channel : "Rick Astley" , views : "1.5B views" , time : "Watched 2 days ago" , duration : "03:33" } , { id : "L_LUpnjgPso" , title : "Grand Theft Auto VI Official Trailer 1" , channel : "Rockstar Games" , views : "215M views" , time : "Watched 3 days ago" , duration : "01:31" } , { id : "0e3GPea1Tyg" , title : "$456,000 Squid Game In Real Life!" , channel : "MrBeast" , views : "630M views" , time : "Watched last week" , duration : "25:41" } , { id : "bMknfKXIFA8" , title : "React Course - Beginner's Tutorial" , channel : "FreeCodeCamp" , views : "8.9M views" , time : "Watched 2 weeks ago" , duration : "11:55:27" } ];

const watchLaterCatalog = [ { id : "aircAruvnKk" , title : "But what is a neural network? | Deep learning, Chapter 1" , channel : "3Blue1Brown" , views : "17.8M views" , duration : "19:13" , avatar : "3" } , { id : "7wnove7K-ZQ" , title : "Python Tutorial for Beginners - Full Course [2025]" , channel : "Programming with Mosh" , views : "38.5M views" , duration : "6:14:07" , avatar : "P" } , { id : "Q7AOvWpIVHU" , title : "Three.js 3D Web Graphics & WebGL Shaders Masterclass" , channel : "Creative Coding 3D" , views : "340K views" , duration : "21:15" , avatar : "T" } , { id : "pTJJsmejUOQ" , title : "Flutter 3.24 & Dart Full Course for Cross-Platform Mobile Apps" , channel : "FreeCodeCamp" , views : "1.4M views" , duration : "4:32:00" , avatar : "F" } ];

const likedCatalog = [ { id : "fJ9rUzIMcZQ" , title : "Queen - Bohemian Rhapsody (Official Video Remastered)" , channel : "Queen Official" , views : "1.7B views" , duration : "05:59" , avatar : "Q" } , { id : "kXYiU_JCYtU" , title : "Linkin Park - Numb (Official Music Video 4K)" , channel : "Linkin Park" , views : "2.2B views" , duration : "03:07" , avatar : "L" } , { id : "h4T_LlK1VE4" , title : "Glitter Bomb 4.0 vs. Porch Pirates" , channel : "Mark Rober" , views : "74.9M views" , duration : "22:30" , avatar : "M" } , { id : "JGwWNGJdvx8" , title : "Ed Sheeran - Shape of You (Official Music Video)" , channel : "Ed Sheeran" , views : "6.2B views" , duration : "04:23" , avatar : "E" } ];

const trendingCatalog = [ { rank : 1 , id : "0e3GPea1Tyg" , title : "$456,000 Squid Game In Real Life!" , channel : "MrBeast" , views : "630M views • Trending #1 on YouTube" , desc : "456 people compete for $456,000 in real life recreation of Squid Game!" , duration : "25:41" } , { rank : 2 , id : "L_LUpnjgPso" , title : "Grand Theft Auto VI Official Trailer 1 - 4K 60FPS" , channel : "Rockstar Games" , views : "215M views • Trending #2 on YouTube" , desc : "Grand Theft Auto VI heads to the state of Leonida, home to the neon-soaked streets of Vice City." , duration : "01:31" } , { rank : 3 , id : "gJrjgg1KVL4" , title : "Spring Boot 3 Full Course 2025 - Beginner to Pro" , channel : "Spandan Prayas Patra" , views : "1.0M views • Trending #3 on YouTube" , desc : "Complete guide to Java 21, Spring Boot 3, and high performance backend engineering." , duration : "1:11:22" } , { rank : 4 , id : "h4T_LlK1VE4" , title : "Glitter Bomb 4.0 vs. Porch Pirates" , channel : "Mark Rober" , views : "74.9M views • Trending #4 on YouTube" , desc : "Custom engineered camera rigs and scent sprayers targeting parcel thieves." , duration : "22:30" } , { rank : 5 , id : "Un5SEJ8MyPc" , title : "Cyberpunk 2077: Phantom Liberty - Official Cinematic Trailer" , channel : "Cyberpunk 2077" , views : "14.2M views • Trending #5 on YouTube" , desc : "Return to Night City in this spy-thriller expansion featuring Idris Elba." , duration : "04:12" } , { rank : 6 , id : "8aGhZQkoFbQ" , title : "Next.js 15 & React 19 Full Stack Masterclass" , channel : "JavaScript Mastery" , views : "489K views • Trending #6 on YouTube" , desc : "Master full-stack Next.js with Server Actions and Cloudflare Deployments." , duration : "2:45:10" } ];

const shortsList = [ { title : "🔥 3 Insane Java 21 Performance Hacks you never knew existed! #Java #SpringBoot #Dev" , author : "@SpandanPrayas" , audio : "🎵 Spandan Original Audio • High Performance Remix" , views : "3.2M" , bg : "linear-gradient(180deg, #1e3a8a, #0f172a)" , vid : "gJrjgg1KVL4" } , { title : "🚀 Write Clean Code in English with Enlang! Zero boilerplate #Enlang #Compilers" , author : "@EnlangOfficial" , audio : "🎵 Enlang Sound Studio • Compiler Waves" , views : "1.8M" , bg : "linear-gradient(180deg, #047857, #064e3b)" , vid : "dQw4w9WgXcQ" } , { title : "🌐 Cloudflare Workers under 1ms Latency around the world #Edge #Cloudflare" , author : "@EdgeArchitects" , audio : "🎵 Ultra Edge Lo-Fi Beat" , views : "950K" , bg : "linear-gradient(180deg, #6d28d9, #2e1065)" , vid : "8aGhZQkoFbQ" } , { title : "✨ Raymarched Black Hole in 30 Lines of WebGL Shader #Threejs #GLSL" , author : "@CreativeCoding3D" , audio : "🎵 Cosmic Raymarch Audio" , views : "2.4M" , bg : "linear-gradient(180deg, #b45309, #451a03)" , vid : "Q7AOvWpIVHU" } , { title : "🎮 GTA 6 Vice City Graphics will blow your mind #GTA6 #Rockstar #Gaming" , author : "@RockstarGames" , audio : "🎵 Love Is A Long Road • Tom Petty" , views : "12.4M" , bg : "linear-gradient(180deg, #831843, #500724)" , vid : "L_LUpnjgPso" } , { title : "⚡ $456,000 Squid Game Behind The Scenes Secret #MrBeast #Challenge" , author : "@MrBeast" , audio : "🎵 Squid Game Official Theme" , views : "45.1M" , bg : "linear-gradient(180deg, #991b1b, #450a0a)" , vid : "0e3GPea1Tyg" } , { title : "💣 Glitter Bomb 4.0 Testing in Secret Lab #MarkRober #Engineering" , author : "@MarkRober" , audio : "🎵 Mission Impossible Remix" , views : "14.2M" , bg : "linear-gradient(180deg, #d97706, #78350f)" , vid : "h4T_LlK1VE4" } , { title : "⚛️ React 19 Actions in 60 Seconds #React #Nextjs #WebDev" , author : "@JSMastery" , audio : "🎵 Lo-Fi Synthwave Beat" , views : "780K" , bg : "linear-gradient(180deg, #065f46, #022c22)" , vid : "bMknfKXIFA8" } ];
...
function renderChaptersForVideo(vidId, title) {
  ...
  if (cWrapper != null) {
    ...
    for (const ch of chs) {
      ...
      btn.onclick = function ( ) { sendPlayerCmd ( "seekTo" , [ ch.sec , true ] ) };
...
function renderCommentsForVideo(vidId, title, channel) {
  ...
  if (cContainer != null) {
    ...
    let mockList = [ { author : channel , badge : "Creator ✓" , time : "1 day ago" , msg : "Source code repository & full timestamps are in the description! Drop your questions below and I will answer every single one." , likes : "428" , isPinned : true } , { author : "@AlexDeveloper" , badge : "" , time : "3 hours ago" , msg : "The explanation in this video is crystal clear! Best video on this topic on YouTube." , likes : "94" , isPinned : false } , { author : "@SarahCode" , badge : "" , time : "6 hours ago" , msg : "Enlang compiling directly to native HTML, CSS, JS with zero boilerplate is revolutionary." , likes : "67" , isPinned : false } , { author : "@DevMaster" , badge : "" , time : "1 day ago" , msg : "Re-watched this 3 times already. The production quality and pacing is top tier." , likes : "32" , isPinned : false } ];
...
function renderSubsGrid() {
  ...
  if (sRow != null) {
    sRow.innerHTML = "";
    let subChannels = [ { name : "Spandan Prayas" , avatar : "S" , bg : "#8b5cf6" } , { name : "MrBeast" , avatar : "M" , bg : "#ef4444" } , { name : "JavaScript Mastery" , avatar : "J" , bg : "#10b981" } , { name : "Programming with Mosh" , avatar : "P" , bg : "#f59e0b" } , { name : "FreeCodeCamp" , avatar : "F" , bg : "#06b6d4" } , { name : "Veritasium" , avatar : "V" , bg : "#3b82f6" } , { name : "Mark Rober" , avatar : "M" , bg : "#6366f1" } , { name : "Rockstar Games" , avatar : "R" , bg : "#ec4899" } ];
  ...
  if (sGrid != null) {
    ...
    for (const item of subsCatalog) {
      ...
      card.onclick = function ( ) { openWatchPage ( item.id , item.title , item.channel , item.views , ( "Latest video from " + item.channel ) , item.avatar ) };
...
function renderLibraryView() {
  ...
  if (hContainer != null) {
    ...
    for (const item of historyCatalog) {
      ...
      card.onclick = function ( ) { openWatchPage ( item.id , item.title , item.channel , item.views , "Watched history stream." , "H" ) };
  ...
  if (wlContainer != null) {
    ...
    for (const item of watchLaterCatalog) {
      ...
      card.className = "video-card";
      card.innerHTML = "<div class='thumbnail-wrapper'><img src='https://i.ytimg.com/vi/" + item.id + "/hqdefault.jpg' class='thumb-real-img' /><span class='duration-badge'>" + item.duration + "</span></div><div class='video-meta'><div class='channel-avatar'>" + item.avatar + "</div><div class='video-details'><h3 class='video-title'>" + item.title + "</h3><p class='video-channel'>" + item.channel + " ✓</p><p class='video-stats'>" + item.views + "</p></div></div>";
      card.onclick = function ( ) { openWatchPage ( item.id , item.title , item.channel , item.views , "Watch Later saved stream." , item.avatar ) };
  ...
  if (lkContainer != null) {
    ...
    for (const item of likedCatalog) {
      ...
      card.className = "video-card";
      card.innerHTML = "<div class='thumbnail-wrapper'><img src='https://i.ytimg.com/vi/" + item.id + "/hqdefault.jpg' class='thumb-real-img' /><span class='duration-badge'>" + item.duration + "</span></div><div class='video-meta'><div class='channel-avatar'>" + item.avatar + "</div><div class='video-details'><h3 class='video-title'>" + item.title + "</h3><p class='video-channel'>" + item.channel + " ✓</p><p class='video-stats'>" + item.views + "</p></div></div>";
      card.onclick = function ( ) { openWatchPage ( item.id , item.title , item.channel , item.views , "Liked videos playlist stream." , item.avatar ) };
...
function renderTrendingList() {
  ...
  if (tContainer != null) {
    ...
    for (const item of trendingCatalog) {
      ...
      card.onclick = function ( ) { openWatchPage ( item.id , item.title , item.channel , item.views , item.desc , "T" ) };
...
function filterByCategory(categoryName) {
  ...
  if (categoryName == "All") {
    ...
    renderGrid ( homeCatalog );
    if (statusTitle != null) {
      statusTitle.textContent = "🔴 All YouTube Feed";
    }
    if (statusDesc != null) {
      statusDesc.textContent = "Displaying " + homeCatalog.length + " live videos across all genres • Infinite Scroll active";
    }
  }
  else {
...
function searchLiveYouTube(query) {
  ...
  let matches = homeCatalog.filter ( function ( v ) { return ( v.title + " " + v.channel + " " + v.desc + " " + v.category ) .toLowerCase ( ) .indexOf ( qLow ) !== - 1 || ( qLow.indexOf ( "gta" ) !== - 1 && v.title.toLowerCase ( ) .indexOf ( "grand theft auto" ) !== - 1 ) || ( qLow.indexOf ( "squid" ) !== - 1 && v.title.toLowerCase ( ) .indexOf ( "squid" ) !== - 1 ) || ( qLow.indexOf ( "mrbeast" ) !== - 1 && v.channel.toLowerCase ( ) .indexOf ( "mrbeast" ) !== - 1 ) } );
  hideAllViews();
  let pFeed = document.getElementById ( "view-feed" );
  if (pFeed != null) {
    pFeed.style.display = "block";
  ...
  if (matches.length > 0) {
    ...
    if (statusDesc != null) {
      statusDesc.textContent = "Found " + matches.length + " matching real YouTube videos (<1s response)";
    }
    ...
    renderGrid ( homeCatalog );
    if (statusTitle != null) {
      statusTitle.textContent = "🔍 Showing top results for: " + q;
    }
    if (statusDesc != null) {
...
if (searchInpEl != null) {
  ...
  searchInpEl.oninput = function ( ) { if ( searchInpEl.value.length >= 2 ) { searchLiveYouTube ( searchInpEl.value ) } };
}
